...
$sp = Get-HPOVServerProfile -Name "chef-web01"
...
```text
$sp = Get-HPOVServerProfile -Name "chef-web01"
Get-HPOVStorageVolume -Name "My New Volume 3" | New-HPOVServerProfileAttachVolume -ServerProfile $sp  | Wait-HPOVTaskComplete
```
...
```text
$storagepool = Get-HPOVStoragePool R1_FC
$sp = Get-HPOVServerProfile -Name "My Server Profile"
