...
$spp = Get-OVSppFile "HP Service Pack for ProLiant" 
$task = Install-OVLogicalInterconnectFirmware Stage $li $spp 
Wait-OVTaskComplete $task
$task = Install-OVLogicalInterconnectFirmware Activate $li 
Wait-OVTaskComplete $task
```
...
```text
Get-OVLogicalInterconnect Encl1-LI  | Install-OVLogicalInterconnectFirmware -method Update -baseline "HP Service Pack for ProLiant" -confirm:$false | Wait-OVTaskComplete
```
