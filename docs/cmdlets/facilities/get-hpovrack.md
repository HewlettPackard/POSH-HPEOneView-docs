...
Retrieve all defined racks on the appliance.
...
* [Remove-HPOVResourceFromRack](https://github.com/HewlettPackard/POSH-HPOneView/wiki/Remove-HPOVResourceFromRack) 
