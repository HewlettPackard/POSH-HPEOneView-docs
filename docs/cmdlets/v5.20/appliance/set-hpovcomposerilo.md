...
Set-HPOVComposerIlo -InputObject $ComposerAppliance -Hostname Myilohost.domian.com -Password $UpdatedSecurePassword
...
```text
$ComposerAppliance = Get-HPOVComposerIloStatus | Where-Object Role -eq "Active"
Set-HPOVComposerIlo -InputObject $ComposerAppliance -IPv4Address 10.16.1.102 -IPv4SubnetMask 23 -IPv4Gateway 10.16.0.1
...
```text
$ComposerAppliance = Get-HPOVComposerIloStatus | Where-Object Role -eq "Standby"
Set-HPOVComposerIlo -InputObject $ComposerAppliance -IPv4Address 10.16.1.103 -IPv4SubnetMask 23 -IPv4Gateway 10.16.0.1
...
The appliance hardware configuration object from Get-HPOVComposerIloStatus.
...
* [Enable-HPOVComposerIlo](enable-hpovcomposerilo.md)
