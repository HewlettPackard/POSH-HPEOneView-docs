...
### SYNTAX
<p>
<pre><code>New-HPOVDataCenter [-Name] &lt;String&gt; [-Width] &lt;Float&gt; [-Depth] &lt;Float&gt;[ [-Millimeters] &lt;SwitchParameter&gt;][ [-ElectricalDerating] &lt;Int&gt;][ [-ElectricalDeratingType] &lt;String&gt;][ [-DefaultVoltage] &lt;Int&gt;][ [-Currency] &lt;String&gt;][ [-PowerCosts] &lt;Float&gt;][ [-CoolingCapacity] &lt;Int&gt;][ [-CoolingMultiplier] &lt;Float&gt;][ [-ApplianceConnection] &lt;Object&gt;] [&lt;CommonParameters&gt;]</code></pre>
 <pre><code>New-HPOVDataCenter [-Name] &lt;String&gt; [-Width] &lt;Float&gt; [-Depth] &lt;Float&gt;[ [-Millimeters] &lt;SwitchParameter&gt;][ [-ElectricalDerating] &lt;Int&gt;][ [-ElectricalDeratingType] &lt;String&gt;][ [-DefaultVoltage] &lt;Int&gt;][ [-Currency] &lt;String&gt;][ [-PowerCosts] &lt;Float&gt;][ [-CoolingCapacity] &lt;Int&gt;][ [-CoolingMultiplier] &lt;Float&gt;] [-PrimaryContact] &lt;Object&gt; [-SecondaryContact] &lt;Object&gt; [-Address1] &lt;String&gt;[ [-Address2] &lt;String&gt;] [-City] &lt;String&gt; [-State] &lt;String&gt; [-PostCode] &lt;String&gt; [-Country] &lt;String&gt; [-TimeZone] &lt;String&gt;[ [-ApplianceConnection] &lt;Object&gt;] [&lt;CommonParameters&gt;]</code></pre>
